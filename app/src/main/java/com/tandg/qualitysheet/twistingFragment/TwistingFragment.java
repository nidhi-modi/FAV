...
public class TwistingFragment extends BaseFragment<TwistingFragmentPresenter> implements TwistingFragmentContract.View, RadioGroup.OnCheckedChangeListener, View.OnClickListener, AdapterView.OnItemSelectedListener {

    private static final String TAG = TwistingFragment.class.getSimpleName();
    ...
    @BindView(R.id.rdg_twisting_data1)                 RadioGroup rdgTwistingData1;
    @BindView(R.id.rdg_twisting_data2)                 RadioGroup rdgTwistingData2;
    @BindView(R.id.rdg_twisting_data3)                 RadioGroup rdgTwistingData3;
    @BindView(R.id.rdg_twisting_data4)                 RadioGroup rdgTwistingData4;

    @BindView(R.id.radio_twisting_data1_yes)           LiquidRadioButton radioTwistingData1yes;
    @BindView(R.id.radio_twisting_data1_no)            LiquidRadioButton radioTwistingData1no;
    @BindView(R.id.radio_twisting_data2_yes)           LiquidRadioButton radioTwistingData2yes;
    @BindView(R.id.radio_twisting_data2_no)            LiquidRadioButton radioTwistingData2no;
    @BindView(R.id.radio_twisting_data3_yes)           LiquidRadioButton radioTwistingData3yes;
    @BindView(R.id.radio_twisting_data3_no)            LiquidRadioButton radioTwistingData3no;
    @BindView(R.id.radio_twisting_data4_yes)           LiquidRadioButton radioTwistingData4yes;
    @BindView(R.id.radio_twisting_data4_no)            LiquidRadioButton radioTwistingData4no;
    ...
    private QualityInfo                               globalQualityInfo, qualityInfo, info;
    ...
    private void initResources() {
        ...
        Log.e(TAG, "Data From Activity to Twisting fragment: " +argJobName+" "+argAuditorName+" "+argHouseNumber+" "+argWeekNumber );
        ...
        rdgTwistingData1.setOnCheckedChangeListener(this);
        rdgTwistingData2.setOnCheckedChangeListener(this);
        rdgTwistingData3.setOnCheckedChangeListener(this);
        rdgTwistingData4.setOnCheckedChangeListener(this);
        ...
        if(ApplicationUtils.isConnected(mActivity)){
            ...
            List<String> arrayList = Arrays.asList(getResources().getStringArray(R.array.fav_names));
    ...
    @Override
    protected TwistingFragmentPresenter getPresenter() {
        return new TwistingFragmentPresenter(this);
    }

    @Override
    protected int getLayout() {
        return R.layout.fragment_twisting;
    }
    ...
    private void validateRowNumber(QualityInfo qualityInfo) {
        ...
        if(rowNumber != null && rowNumber.trim().length() > 0){
            ...
            validateTwistingData1(qualityInfo);
    ...
    private void validateTwistingData1(QualityInfo qualityInfo) {

        if(radioData1!= null && radioData1.trim().length() > 0){

            qualityInfo.setQualityData1(radioData1);

            validateTwistingData2(qualityInfo);

        }else {

            hideProgressDialog();
            ApplicationUtils.showToast(mActivity,"Choose One Option from Trusses and Leaves not Trapped");

        }

    }

    private void validateTwistingData2(QualityInfo qualityInfo) {

        if(radioData2!= null && radioData2.trim().length() > 0){

            qualityInfo.setQualityData2(radioData2);

            validateTwistingData3(qualityInfo);
    ...
    private void validateTwistingData3(QualityInfo qualityInfo) {

        if(radioData3!= null && radioData3.trim().length() > 0){

            qualityInfo.setQualityData3(radioData3);

            validateTwistingData4(qualityInfo);

        }else {

            hideProgressDialog();
            ApplicationUtils.showToast(mActivity,"Choose One Option from Broken Heads Replaced");

        }
    }

    private void validateTwistingData4(QualityInfo qualityInfo) {

        if(radioData4!= null && radioData4.trim().length() > 0){

            qualityInfo.setQualityData4(radioData4);

            validateTwistingComments(qualityInfo);
    ...
    private void validateTwistingComments(QualityInfo qualityInfo) {
    ...
    private void clearText() {
        ...
        edtComments.setText("");
        rdgTwistingData1.clearCheck();
        rdgTwistingData2.clearCheck();
        rdgTwistingData3.clearCheck();
        rdgTwistingData4.clearCheck();
    ...
    public void onCheckedChanged(RadioGroup group, int id) {
        ...
        if(id == R.id.radio_twisting_data1_yes){

            radioData1 = QUALITY_YES;

        }

        if(id == R.id.radio_twisting_data1_no){

            radioData1 = QUALITY_NO;

        }

        if(id == R.id.radio_twisting_data2_yes){

            radioData2 = QUALITY_YES;

        }

        if(id == R.id.radio_twisting_data2_no){

            radioData2 = QUALITY_NO;

        }

        if(id == R.id.radio_twisting_data3_yes){

            radioData3 = QUALITY_YES;

        }

        if(id == R.id.radio_twisting_data3_no){

            radioData3 = QUALITY_NO;

        }

        if(id == R.id.radio_twisting_data4_yes){

            radioData4 = QUALITY_YES;

        }

        if(id == R.id.radio_twisting_data4_no){
